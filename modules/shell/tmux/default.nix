        ...
        plugins = with pkgs.tmuxPlugins; [
          ...
          copycat
          {
            ...
            extraConfig = ''
              ...
              ${lib.optionalString (config.ide.emacs.core.daemon.enable) ''
                (setenv "EDITOR" "${config.ide.emacs.core.package}/bin/emacsclient -c -s /run/user/${config.attributes.mainUser.ID}/emacs/server")
              ''}
            '';
          }
          fpp
