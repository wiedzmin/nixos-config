self: super: {
  ...
  vcrpy = super.python3Packages.buildPythonPackage rec {
    ...
    checkInputs = with super.python3Packages; [ pytest self.pytest-httpbin ];

    propagatedBuildInputs = with super.python3Packages; [ pyyaml six wrapt yarl ];
  ...
  buku = super.python3Packages.buildPythonApplication rec {
    ...
    checkInputs = with super.python3Packages; [ flake8 hypothesis mypy_extensions pylint pytest pytestcov pyyaml ];
