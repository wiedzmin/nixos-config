...
basicKeys conf = [ "C-\\"         ~> sendMessage (XkbToggle Nothing)
                 ...
                 , "M-/"          ~> spawn "@rofiSearchenginesSelection@" >> WS.showWSOnProperScreen "web"
                 , "M-C-/"        ~> spawn "@rofiSearchenginesPrompt@" >> WS.showWSOnProperScreen "web"
                 , "M-C-d"        ~> spawn "@rofiDockerShell@" >> WS.showWSOnProperScreen "shell"
                 , "M-C-j"        ~> spawn "@rofiServiceJournal@" >> WS.showWSOnProperScreen "shell"
                 , "M-C-l"        ~> spawn "@rofiRemoteDockerLogs@" >> WS.showWSOnProperScreen "shell"
                 , "M-C-s"        ~> spawn "@rofiDockerStacksInfo@" >> WS.showWSOnProperScreen "shell"
                 , "M-C-y"        ~> spawn "@rofiDbms@" >> WS.showWSOnProperScreen "shell"
                 ...
                 , "M-C-c"        ~> spawn "@rofiDockerContainerTraits@"
                 , "M-C-h"        ~> spawn "@rofiExtraHostsTraits@"
                 , "M-C-m"        ~> spawn "@rofiMountNasVolume@"
                 , "M-C-t"        ~> spawn "@rofiTmuxpSessions@"
                 , "M-C-u"        ~> spawn "@rofiUnmountNasVolume@"
                 , "M-S-b"        ~> spawn "@rofiBookshelf@"
                 , "M-S-u"        ~> spawn "@showUptimeInfo@"
                 , "M-y"          ~> spawn "@rofiBukuAdd@"
