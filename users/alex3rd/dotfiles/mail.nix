...
in
{
    home-manager.users.alex3rd = {
        accounts.email = {
            accounts."personal" = {
                ...
                passwordCommand = "${pkgs.pass_imap_helper}/bin/pass_imap_helper ${config.common.userTraits.googleAccountPasswordPath}";
                signature = {
                    showSignature = "none";
    ...
    environment.etc."imapfilter_config.lua".text = ''
        ...
        account_personal = IMAP {
            ...
            username = '${config.common.userTraits.email}',
            password = io.popen('${pkgs.pass_imap_helper}/bin/pass_imap_helper ${config.common.userTraits.googleAccountPasswordPath}', 'r'):read("*a"),
            ssl = 'tls'
        }
