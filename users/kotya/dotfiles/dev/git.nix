    ...
    home-manager.users.kotya = {
        ...
        programs.git = {
            ...
            extraConfig = {
                ...
                "commit" = {
                    template = "${config.users.extraUsers.kotya.home}/git-assets/git-commit-template";
                };
                "rebase" = {
                    autoSquash = true;
                };
                "core" = {
                    autocrlf = false;
                    excludesfile = "${config.users.extraUsers.kotya.home}/git-assets/.gitignore";
                    quotepath = false;
                    askPass = "";
                    hooksPath = "${config.users.extraUsers.kotya.home}/git-assets/templates/hooks";
                };
                "credential" = {
                ...
                "init" = {
                    templatedir = "${config.users.extraUsers.kotya.home}/git-assets/templates";
                };
                "clone" = {
                    templatedir = "${config.users.extraUsers.kotya.home}/git-assets/templates";
                };
                ...
                "ghq" = {
                    root = "${config.users.extraUsers.kotya.home}/workspace/repos";
                };
                "ghq \"import\"" = {
